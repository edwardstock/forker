...
/**
 * This serializer uses SuperClosure project that helps you to serialize Closures!
 * Now you can serialize any object, even it has a some closures in properties
 *
 * forker. 2016
...
class Serializer
{
     ...
     * @return string
     */
    public static function serialize($any): string
    {
